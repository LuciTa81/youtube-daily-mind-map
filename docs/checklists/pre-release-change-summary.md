...
## GitHub Actions APK Emulator Clean Install Smoke Result - 2026-06-03 (7ec33e2)

Device: Android Emulator `codex_clean_api36`, model `sdk_gphone64_x86_64`, Android 16, API 36.
APK: GitHub Actions artifact `youtube-daily-mind-map-debug-apk` from `Build Android APK` run `26853716256`, artifact id `7372107428`, extracted as `app-debug.apk`, size 4,635,774 bytes.
Build commit: `7ec33e236f946592ea16f2da1f08e80eba2082fc`.
...
- [x] App launched and `.MainActivity` became the resumed activity.
- [x] Current focus was `com.lucita81.youtubedailymindmap/com.lucita81.youtubedailymindmap.MainActivity`.
- [x] Home screen screenshot was captured at `C:\Users\IML4\AppData\Local\Temp\codex-7ec33e2-emulator-clean-install-launch-after-wait.png`.
- [x] Home screen rendered with the header, summary cards, import button, and bottom navigation visible in the emulator screenshot.
- [x] `uiautomator dump` created `C:\Users\IML4\AppData\Local\Temp\codex-7ec33e2-emulator-window.xml`, size 1,238 bytes.
- [x] App process was alive after launch and strict filtered logcat showed no `FATAL EXCEPTION`, `Process com.lucita81.youtubedailymindmap has died`, or `Force finishing activity com.lucita81.youtubedailymindmap` lines.
- [x] Emulator was shut down after smoke testing and no emulator remained connected.
...
## GitHub Actions APK Emulator Clean Install Smoke Result - 2026-06-03 (1768952)

Device: Android Emulator `codex_clean_api36`, model `sdk_gphone64_x86_64`, Android 16, API 36.
APK: GitHub Actions artifact `youtube-daily-mind-map-debug-apk` from `Build Android APK` run `26854263946`, artifact id `7372326613`, extracted as `app-debug.apk`, size 4,635,774 bytes.
Build commit: `1768952a66c0da3d3805c83c3abbac6dd9b7a0d1`.
...
- [x] Installed APK reported `versionCode=1`, `versionName=1.0`, `minSdk=24`, and `targetSdk=36`.
- [x] App launched and `.MainActivity` became the resumed activity.
- [x] Initial screenshot showed a `System UI isn't responding` dialog, so the smoke tapped `Wait` and rechecked the app after the system UI recovered.
- [x] After the system UI wait, current focus was `com.lucita81.youtubedailymindmap/com.lucita81.youtubedailymindmap.MainActivity`.
- [x] Home screen screenshot was captured at `C:\Users\IML4\AppData\Local\Temp\codex-1768952-emulator-clean-install-launch-after-systemui-wait.png`.
...
- [x] `uiautomator dump` created `C:\Users\IML4\AppData\Local\Temp\codex-1768952-emulator-window-after-systemui-wait.xml`, size 2,785 bytes.
- [x] App process was alive after launch and strict filtered logcat showed no `FATAL EXCEPTION`, `Process com.lucita81.youtubedailymindmap has died`, or `Force finishing activity com.lucita81.youtubedailymindmap` lines.
- [x] Emulator was shut down after smoke testing and no emulator remained connected.
...
- This was a GitHub Actions debug artifact, not a release or Play Store signed artifact.
- This smoke confirms clean install and first-screen launch only; Drive import, YouTube share, duplicate import, deletion, and layout flows were not repeated on the emulator.
- The first screenshot showed a System UI ANR dialog before the app became focused; the app itself did not crash, but emulator stability should be watched in future smoke runs.
- `uiautomator dump` produced a limited WebView hierarchy, so Home render evidence depends on the screenshot plus resumed-activity/current-focus state.
- A real standard non-foldable Android phone still needs smoke before broad sharing.

## GitHub Actions APK Emulator Clean Install Smoke Result - 2026-06-03 (205656e)

Device: Android Emulator `codex_clean_api36`, model `sdk_gphone64_x86_64`, Android 16, API 36.
APK: GitHub Actions artifact `youtube-daily-mind-map-debug-apk` from `Build Android APK` run `26855098439`, artifact id `7372650349`, extracted as `app-debug.apk`, size 4,635,786 bytes.
Build commit: `205656e3f291f724fbd064042d9016c5b462fdd2`.
...
- [x] App launched and `.MainActivity` became the resumed activity.
- [x] Current focus was `com.lucita81.youtubedailymindmap/com.lucita81.youtubedailymindmap.MainActivity`.
- [x] Initial screenshot was captured at `C:\Users\IML4\AppData\Local\Temp\codex-205656e-emulator-clean-install-launch-after-wait.png` and still showed the app skeleton screen.
- [x] After an extra wait, Home screen screenshot was captured at `C:\Users\IML4\AppData\Local\Temp\codex-205656e-emulator-clean-install-launch-after-extra-wait.png`.
- [x] Home screen rendered with the header, summary cards, import button, date-range card, and bottom navigation visible in the emulator screenshot.
- [x] `uiautomator dump` created `C:\Users\IML4\AppData\Local\Temp\codex-205656e-emulator-window-extra.xml`, size 35,036 bytes.
- [x] App process was alive after launch and strict filtered logcat showed no `FATAL EXCEPTION`, `Process com.lucita81.youtubedailymindmap has died`, or `Force finishing activity com.lucita81.youtubedailymindmap` lines.
- [x] Emulator was shut down after smoke testing and no emulator remained connected.
...
- This was a GitHub Actions debug artifact, not a release or Play Store signed artifact.
- This smoke confirms clean install and first-screen launch only; Drive import, YouTube share, duplicate import, deletion, and layout flows were not repeated on the emulator.
- The first screenshot showed only the app skeleton screen, so the Home render evidence depends on the later screenshot plus resumed-activity/current-focus state.
- A real standard non-foldable Android phone still needs smoke before broad sharing.

## GitHub Actions APK Emulator Clean Install Smoke Result - 2026-06-03 (8a086cb)

Device: Android Emulator `codex_clean_api36`, model `sdk_gphone64_x86_64`, Android 16, API 36.
APK: GitHub Actions artifact `youtube-daily-mind-map-debug-apk` from `Build Android APK` run `26856111989`, artifact id `7373021317`, extracted as `app-debug.apk`, size 4,635,766 bytes.
Build commit: `8a086cb0238cb1e79ed4bc745409d1a11b52d9f5`.

- [x] Artifact ZIP downloaded from GitHub Actions; size 4,249,039 bytes.
- [x] Artifact ZIP SHA256 matched the GitHub artifact digest `a1c81e075470ae9e757200db3a279f7cad3c31b8472142a358f5c2e98914e195`.
- [x] `app-debug.apk` was extracted from the artifact.
- [x] `apksigner verify` passed.
- [x] APK Signature Scheme v2 verified true.
- [x] APK signer was `C=US, O=Android, CN=Android Debug`.
...
- [x] Emulator boot completed on model `sdk_gphone64_x86_64`, Android 16, API 36, with physical size `1080x1920`.
- [x] APK clean installed on the emulator with `adb install`.
- [x] Installed package code path was under `/data/app/.../com.lucita81.youtubedailymindmap...`.
- [x] Installed APK reported `versionCode=1`, `versionName=1.0`, `minSdk=24`, and `targetSdk=36`.
- [x] App launched and `.MainActivity` became the resumed activity.
- [x] Current focus was `com.lucita81.youtubedailymindmap/com.lucita81.youtubedailymindmap.MainActivity`.
- [x] App process was alive after launch with pid `2943`.
- [x] Home screen screenshot was captured at `C:\Users\IML4\AppData\Local\Temp\codex-8a086cb-emulator-clean-install-launch-after-wait.png`, size 280,740 bytes.
- [x] Home screen rendered with the header, summary cards, import button, date-range card, and bottom navigation visible in the emulator screenshot.
- [x] `uiautomator dump` created `C:\Users\IML4\AppData\Local\Temp\codex-8a086cb-emulator-window.xml`, size 2,785 bytes.
- [x] App process was alive after launch and strict filtered logcat showed no `FATAL EXCEPTION`, `Process com.lucita81.youtubedailymindmap has died`, or `Force finishing activity com.lucita81.youtubedailymindmap` lines.
- [x] Emulator was shut down after smoke testing and no emulator remained connected.
...
## GitHub Actions APK Emulator Clean Install Smoke Result - 2026-06-03 (bf8880a)

Device: Android Emulator `codex_clean_api36`, model `sdk_gphone64_x86_64`, Android 16, API 36.
APK: GitHub Actions artifact `youtube-daily-mind-map-debug-apk` from `Build Android APK` run `26856656716`, artifact id `7373230313`, extracted as `app-debug.apk`, size 4,635,790 bytes.
Build commit: `bf8880a42bae8290005b0e31073647007a158f99`.

- [x] Artifact ZIP downloaded from GitHub Actions; size 4,249,046 bytes.
- [x] Artifact ZIP SHA256 matched the GitHub artifact digest `42af32afd547ede2a982fd6573d40687b2d256f70fffb920e3b90c51f70e98c9`.
- [x] `app-debug.apk` was extracted from the artifact.
- [x] `apksigner verify` passed.
- [x] APK Signature Scheme v2 verified true.
- [x] APK signer was `C=US, O=Android, CN=Android Debug`.
...
- [x] Current focus was `com.lucita81.youtubedailymindmap/com.lucita81.youtubedailymindmap.MainActivity`.
- [x] App process was alive after launch with pid `2801`.
- [x] Home screen screenshot was captured at `C:\Users\IML4\AppData\Local\Temp\codex-bf8880a-emulator-clean-install-launch-after-wait.png`, size 280,281 bytes.
- [x] Home screen rendered with the header, summary cards, import button, date-range card, and bottom navigation visible in the emulator screenshot.
- [x] `uiautomator dump` created `C:\Users\IML4\AppData\Local\Temp\codex-bf8880a-emulator-window.xml`, size 2,785 bytes.
- [x] App process was alive after launch and strict filtered logcat showed no `FATAL EXCEPTION`, `Process com.lucita81.youtubedailymindmap has died`, or `Force finishing activity com.lucita81.youtubedailymindmap` lines.
- [x] Emulator was shut down after smoke testing and no emulator remained connected.
...
## GitHub Actions APK Artifact Verification Result - 2026-06-03 (68c8ef3)

APK: GitHub Actions artifact `youtube-daily-mind-map-debug-apk` from `Build Android APK` run `26857188380`, artifact id `7373441909`, extracted as `app-debug.apk`, size 4,635,774 bytes.
Build commit: `68c8ef37ae0e6d8f46afbc9857fa85edc2f36f1d`.

- [x] `Build Android APK` completed successfully for commit `68c8ef3`.
- [x] Artifact ZIP downloaded from GitHub Actions; size 4,249,038 bytes.
- [x] Artifact ZIP SHA256 was `0ad23e2890fe12e8deed83f63573699203e58ad0187e87cd75b924d7de8c991b`.
- [x] `app-debug.apk` was extracted from the artifact.
- [x] APK SHA256 was `f336ec50677b4f3470699dfe58309cd32c3c5b1f29297c8ac96a1094469beafe`.
...
- This was a GitHub Actions debug artifact, not a release or Play Store signed artifact.
- This verification confirms artifact download, extraction, APK signature, and package metadata only; install and launch were repeated in the follow-up emulator smoke, but Drive import, YouTube share, duplicate import, deletion, and layout flows were not repeated for commit `68c8ef3`.

## GitHub Actions APK Emulator Clean Install Smoke Result - 2026-06-03 (68c8ef3)
...
- [x] App cold-launched and `.MainActivity` became the resumed activity.
- [x] Launch output reported `Status: ok`, `LaunchState: COLD`, `TotalTime: 9001`, and `WaitTime: 9164`.
- [x] Current focus was `com.lucita81.youtubedailymindmap/com.lucita81.youtubedailymindmap.MainActivity`.
- [x] App process was alive after launch with pid `3054`.
- [x] Home screen screenshot was captured at `C:\Users\IML4\AppData\Local\Temp\codex-68c8ef3-emulator-clean-install-launch-after-wait.png`, size 280,243 bytes.
- [x] Home screen rendered with the header, summary cards, import button, date-range card, and bottom navigation visible in the emulator screenshot.
- [x] `uiautomator dump` created `C:\Users\IML4\AppData\Local\Temp\codex-68c8ef3-emulator-window.xml`, size 2,785 bytes.
- [x] App process was alive after launch and strict filtered logcat showed no `FATAL EXCEPTION`, `Process com.lucita81.youtubedailymindmap has died`, or `Force finishing activity com.lucita81.youtubedailymindmap` lines.
- [x] Emulator was shut down after smoke testing and no emulator remained connected.
...
## GitHub Actions APK Artifact Verification Result - 2026-06-03 (20b6b3c)

APK: GitHub Actions artifact `youtube-daily-mind-map-debug-apk` from `Build Android APK` run `26857727829`, artifact id `7373647675`, extracted as `app-debug.apk`, size 4,635,774 bytes.
Build commit: `20b6b3c95cd150d09d4d2265ac6c376707b29898`.

- [x] `Build Android APK` completed successfully for commit `20b6b3c`.
- [x] Artifact ZIP downloaded from GitHub Actions; size 4,249,042 bytes.
- [x] Artifact ZIP SHA256 was `e7bebb0f0f3125ffc12d16b50025ff7712afcb3e981ea5c77ff01b3416adddd8`.
- [x] `app-debug.apk` was extracted from the artifact.
- [x] APK SHA256 was `a0cdfa57f1e7aab2009289bb6e791a1890a23bb6fd8b8c615137ce457cc825c6`.
- [x] `apksigner verify` passed after setting `JAVA_HOME` to the Android Studio JBR.
- [x] APK Signature Scheme v2 verified true.
- [x] APK signer was `C=US, O=Android, CN=Android Debug`.
- [x] `aapt dump badging` found package `com.lucita81.youtubedailymindmap`.
...
- This was a GitHub Actions debug artifact, not a release or Play Store signed artifact.
- This verification confirms artifact download, extraction, APK signature, and package metadata only; install and launch were repeated in the follow-up emulator smoke, but Drive import, YouTube share, duplicate import, deletion, and layout flows were not repeated for commit `20b6b3c`.

## GitHub Actions APK Emulator Clean Install Smoke Result - 2026-06-03 (20b6b3c)

Device: Android Emulator `codex_clean_api36`, model `sdk_gphone64_x86_64`, Android 16, API 36.
APK: GitHub Actions artifact `youtube-daily-mind-map-debug-apk` from `Build Android APK` run `26857727829`, artifact id `7373647675`, extracted as `app-debug.apk`, size 4,635,774 bytes.
Build commit: `20b6b3c95cd150d09d4d2265ac6c376707b29898`.

- [x] The first emulator start attempt created an emulator crash dump and did not attach to ADB, so the failed process was cleaned up before retrying.
- [x] Clean AVD `codex_clean_api36` was relaunched with `-wipe-data`, `-no-window`, and `-gpu swiftshader_indirect`.
- [x] Emulator boot completed on model `sdk_gphone64_x86_64`, Android 16, API 36, with physical size `1080x1920`.
- [x] APK clean installed on the emulator with `adb install`.
- [x] Launcher resolved to `com.lucita81.youtubedailymindmap/.MainActivity`.
- [x] Installed package code path was under `/data/app/.../com.lucita81.youtubedailymindmap.../base.apk`.
...
- [x] Installed package flags included `DEBUGGABLE`, as expected for the GitHub Actions debug artifact.
- [x] App cold-launched and `.MainActivity` became the resumed activity.
- [x] Launch output reported `Status: ok`, `LaunchState: COLD`, `TotalTime: 7735`, and `WaitTime: 7807`.
- [x] Current focus was `com.lucita81.youtubedailymindmap/com.lucita81.youtubedailymindmap.MainActivity`.
- [x] App process was alive after launch with pid `2731`.
- [x] Home screen screenshot was captured at `C:\Users\IML4\AppData\Local\Temp\codex-20b6b3c-emulator-clean-install-launch-after-wait.png`, size 279,172 bytes.
- [x] Home screen rendered with the header, summary cards, import button, date-range card, and bottom navigation visible in the emulator screenshot.
- [x] `uiautomator dump` created `C:\Users\IML4\AppData\Local\Temp\codex-20b6b3c-emulator-window.xml`, size 2,785 bytes.
- [x] App process was alive after launch and strict filtered logcat showed no `FATAL EXCEPTION`, `Process com.lucita81.youtubedailymindmap has died`, or `Force finishing activity com.lucita81.youtubedailymindmap` lines.
- [x] Emulator was shut down after smoke testing and no emulator remained connected.
